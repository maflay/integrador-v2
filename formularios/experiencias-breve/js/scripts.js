...
window.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .getElementById("si_va_otros_casinos")
  ...
  document
    .getElementById("no_va_otros_casinos")
    .addEventListener("click", () => {
  ...
  submit_exp.addEventListener("click", async () => {
    ...
    let data = {
      ...
      personal_casino:
        document.getElementById("personal_casino").checked == true
          ? "Si"
          : "No",
      material_grafico:
        document.getElementById("material_grafico").checked == true
          ? "Si"
          : "No",
      recibir_whatsapp:
        document.getElementById("recibir_whatsapp").checked == true
          ? "Si"
          : "No",
      recibir_email:
        document.getElementById("recibir_email").checked == true ? "Si" : "No",
      recibir_llamada:
        document.getElementById("recibir_llamada").checked == true
          ? "Si"
          : "No",
      recibir_mensaje:
        document.getElementById("recibir_mensaje").checked == true
          ? "Si"
          : "No",
      visitaOtros:
