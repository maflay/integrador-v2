...
window.addEventListener("DOMContentLoaded", () => {
  const cedula_pereira = document.getElementById("cedula_pereira");
  const nombre_pereira = document.getElementById("nombre_pereira");
  const casino_pereira = document.getElementById("casino_pereira");
  const casino_modal_pereira = document.getElementById("casino_modal_pereira");
  const casino_modal_descripcion_pereira = document.getElementById(
    "casino_modal_descripcion_pereira"
  );
  const url =
  ...
  const cedulaGet_pereira = document.getElementById("cedulaGet_pereira");

  btn_submit_casino.addEventListener("click", () => {
    const cedula_pereira_val = cedula_pereira.value;
    const nombre_pereira_val = nombre_pereira.value;
    const casino_pereira_val = casino_pereira.value;
    ...
    if (cedula_pereira_val == "" || nombre_pereira_val == "") {
      Swal.fire({
        icon: "warning",
    ...
    const data = {
      tipo: "registro",
      nombre: nombre_pereira_val,
      edad: fecha_all,
      cedula: cedula_pereira_val,
      correo: casino_pereira_val,
      bono: "",
    };
      ...
      .then((data) => {
        if (data.length > 0) {
          ...
          fetch(url, {
            ...
            .then(() => {
              nombre_pereira.value = "";
              cedula_pereira.value = "";
              casino_pereira.value = "";
              getAllClientes();
              setTimeout(() => {
                loader.style.display = "none";
                Swal.fire({
  ...
  btn_consultat_finalista_casino.addEventListener("click", () => {
    const cedulaGet_pereira_val = cedulaGet_pereira.value;

    if (cedulaGet_pereira_val == "") {
      Swal.fire({
        icon: "warning",
        title: "Campos en blanco.",
  ...
  btnObservacionSubmit.addEventListener("click", () => {
    const casino_modal_pereira_val = casino_modal_pereira.value;
    const casino_modal_descripcion_pereira_val =
      casino_modal_descripcion_pereira.value;
    ...
    if (
      casino_modal_pereira_val == "" ||
      casino_modal_descripcion_pereira_val == ""
    ) {
      Swal.fire({
        icon: "warning",
        title: "Campos en blanco",
    ...
    const data = {
      ...
      hora: hora,
      fecha: fecha,
      casino: casino_modal_pereira_val,
  ...
  function getAllClientes() {
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        container.innerHTML = `
        <div class="table-result-pereira table-scrolld-pereira">
          <table class="styled-table-pereira">
            <thead>
              <tr>
                <th># Registro</th>
                <th>Nombre</th>
  ...
  function getCliente() {
    const cedula = document.getElementById("cedulaGet_pereira").value;
    const loader = document.getElementById("loader");
