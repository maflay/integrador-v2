        ...
        contenedor.innerHTML = filtrados
          .map((r, i) => {
            ...
            <div class="content_card">
              ...
              <h4 style="font-size: 0.8rem;"><span>Nombre</span> : ${r.Nombre ?? "-"}</h4>
...
function getAllPaticipantes() {
  ...
  getResultadoPartido().then((resultadoPartido) => {
    resultado_partido_final.innerHTML = `${
      resultadoPartido == ""
        ? " <p>Sin Resultado...</p>"
        : `<div>Resultado Final<p style="font-size: 2rem;">${resultadoPartido}</p></div>`
    }`;
...
`;
            ...
            (registro) => `
              <div class="content_card_last_participante">
                ...
                <p>Nombre : ${registro.Nombre} 
                  <img class="img_last_participante" src="/dinamicas/promocion-futbolera-VEN-COL/resource/icono2.png">
                </p>
              </div>
            `
          )
      ...
      //           <p>Resultado Final</p>
      //           ${
      //             resultadoFijo == "" ? `<p>Sin Resultado aun</p>` : `<span style="font-size: 2rem;">${resultadoFijo}</span>`
      //           } 
      //       `
      //     )
      //     .join("")}
...
function refrescarScore() {
  ...
  getResultadoPartido().then((resultadoPartido) => {
    ...
    resultado_partido_final.innerHTML = `${
      resultadoPartido == ""
        ? " <p>Sin Resultado...</p>"
        : `<div>Resultado<p style="font-size: 2rem;">${resultadoPartido}</p></div>`
    }`;
  });
}
