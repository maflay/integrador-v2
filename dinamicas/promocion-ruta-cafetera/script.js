...
const clasesPosiciones_1 = [
  "calle_del_cafe", //clase de inicio
  "desfile_arrieros",
  "parque_rebeca",
  "feria_del_gallo",
  "obelisco",
  "estadio_futbol", // maxima posicion avance 1
];
...
categoria.addEventListener("change", () => {
  ...
  posiciones.forEach((val) => {
    ...
    } else if (categoria.value == "SUPERIOR") {
...
const LS_KEY = "registrosRutaCafetera";
const FECHA_KEY = "fechaRutaCafetera";
const promocion = "La Ruta Cafetera";
...
const url =
  "https://script.google.com/macros/s/AKfycbyxkQ1Vx39pjv1IouMk33_QH9LETHQFQHbofF_bKbNxXiJbDoniMD71YwZTpfTS1VFY/exec";
