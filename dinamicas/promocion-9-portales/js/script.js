...
document.getElementById("pausarSonido").addEventListener("click", pausarSonido);
...
const btn_dados_menos_casilla = document.getElementById("dados_menos_casilla");
...
categoria_val.addEventListener("change", () => {
  if (categoria_val.value == "" || categoria_val.value == "ADICIONAL") {
    ...
    document.getElementById("content_control_btn").style.pointerEvents = "auto";
...
btn_submit.addEventListener("click", () => {
  ...
  if (categoria_val == "" || casino_val == "" || nombre_val == "") {
    Swal.fire({
      icon: "warning",
...
const btn_submit_observacion = document.getElementById("btn_envia_observacion");
